...
public class VentaPago {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "venta_pago_seq")
    @SequenceGenerator(name = "venta_pago_seq", sequenceName = "venta_pago_id_venta_pago_seq", allocationSize = 1)
