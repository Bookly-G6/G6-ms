...
class ProductoServiceTest {
    ...
    void listarSegunRolAdminIncluyeProductosInactivos() {
        ...
        TipoProductoRepository tipoProductoRepository = mock(TipoProductoRepository.class);
        EditorialSelloRepository editorialSelloRepository = mock(EditorialSelloRepository.class);
        ...
        when(productoRepository.findAll()).thenReturn(List.of(productoActivo, productoInactivo));

        Authentication authentication = mock(Authentication.class);
        Collection<GrantedAuthority> authorities = List.of(new SimpleGrantedAuthority("ROLE_ADMIN"));
        when(authentication.getAuthorities()).thenReturn((Collection) authorities);

        List<ProductoResponseDTO> productos = productoService.listarSegunRol(authentication);
    ...
    void listarSegunRolClienteSoloIncluyeProductosActivos() {
        ...
        assertEquals(productoActivo.getIdProducto(), productos.get(0).getIdProducto());
    }
